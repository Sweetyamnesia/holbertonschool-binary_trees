...
/**
 * binary_tree_insert_left - insèr un noeud en tant qu enfant gauche
 *  d'un autre noeud
 * @parent: pointeur vers le noeud parent dans lequel insérer l noeud gauche
 ...
 * Return: pointeur vers le nouveau noeud ou NULL en cas d'éche
